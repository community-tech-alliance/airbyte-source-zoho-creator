...
```
./gradlew :airbyte-integrations:connectors:source-zoho-creator:build
```
...
**If you are an Airbyte core member**, copy the credentials in Lastpass under the secret name `source zoho-creator test creds`
...
```
./gradlew :airbyte-integrations:connectors:source-zoho-creator:airbyteDocker
```
...
To run unit tests:
```
./gradlew :airbyte-integrations:connectors:source-zoho-creator:unitTest
```
To run acceptance and custom integration tests:
```
./gradlew :airbyte-integrations:connectors:source-zoho-creator:integrationTest
```
