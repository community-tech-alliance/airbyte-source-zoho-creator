...
import pytest
from source_zoho_creator.source import ZohoCreatorStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ZohoCreatorStream, "path", "v0/example_endpoint")
    mocker.patch.object(ZohoCreatorStream, "primary_key", "test_primary_key")
    mocker.patch.object(ZohoCreatorStream, "__abstractmethods__", set())
